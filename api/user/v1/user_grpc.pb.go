...
const (
	...
	User_LoginByUsername_FullMethodName = "/api.user.v1.User/LoginByUsername"
)
...
func (c *userClient) LoginByUsername(ctx context.Context, in *LoginByUsernameRequest, opts ...grpc.CallOption) (*LoginByUsernameReply, error) {
	out := new(LoginByUsernameReply)
	err := c.cc.Invoke(ctx, User_LoginByUsername_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) LoginByUsername(context.Context, *LoginByUsernameRequest) (*LoginByUsernameReply, error) {
...
func _User_LoginByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_LoginByUsername_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
