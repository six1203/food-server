...
type Config struct {
	...
	UserBlacklist []string `protobuf:"bytes,4,rep,name=userBlacklist,proto3" json:"userBlacklist,omitempty"`
}
...
func (x *Config) GetUserBlacklist() []string {
	if x != nil {
		return x.UserBlacklist
	}
	return nil
}
...
type JWT struct {
	...
	ExpireDuration int32  `protobuf:"varint,2,opt,name=expire_duration,json=expireDuration,proto3" json:"expire_duration,omitempty"`
}
...
func (x *JWT) GetExpireDuration() int32 {
	if x != nil {
...
func (x *UserBlacklist) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserBlacklist) ProtoMessage() {}

func (x *UserBlacklist) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserBlacklist.ProtoReflect.Descriptor instead.
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x21, 0x0a, 0x03, 0x6a, 0x77,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4a, 0x57, 0x54, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x12, 0x24, 0x0a,
	0x0d, 0x75, 0x73, 0x65, 0x72, 0x42, 0x6c, 0x61, 0x63, 0x6b, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0d, 0x75, 0x73, 0x65, 0x72, 0x42, 0x6c, 0x61, 0x63, 0x6b, 0x6c,
	0x69, 0x73, 0x74, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b,
	...
	0x6c, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x64, 0x62, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x64, 0x62, 0x22, 0x46, 0x0a, 0x03, 0x4a, 0x57, 0x54, 0x12,
	0x16, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x27, 0x0a, 0x0f, 0x65, 0x78, 0x70, 0x69, 0x72,
	...
	0x22, 0x0f, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x42, 0x6c, 0x61, 0x63, 0x6b, 0x6c, 0x69, 0x73,
	0x74, 0x42, 0x20, 0x5a, 0x1e, 0x66, 0x6f, 0x6f, 0x64, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*UserBlacklist)(nil),       // 4: kratos.api.UserBlacklist
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Config.jwt:type_name -> kratos.api.JWT
